...
logger.info("Initializing Lark Sheet client. " f"sheet_token={sheet_token}, " f"input_id={input_id}, " f"output_id={output_id}, " f"record_id={record_id}")
...
if not requestor_ok and not data_ok: # Flase + False
    error_message = "Input validation failed: 'Requestor' 欄位未填寫，且未提供任何s 'Account' 或 'UserId' 查詢資料。"
